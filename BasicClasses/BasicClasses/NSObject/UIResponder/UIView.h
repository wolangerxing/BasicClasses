...
typedef NS_OPTIONS(NSUInteger, UIViewAnimationOptions) {} NS_ENUM_AVAILABLE_IOS(4_0);
typedef NS_OPTIONS(NSUInteger, UIViewKeyframeAnimationOptions) {} NS_ENUM_AVAILABLE_IOS(7_0);
...
// MARK: - 第 1 个讲解 转换视图间坐标
// 获取当前screen旋转之后的坐标体系
// 有时候需要在 Core Graphics 和 UIKit 的坐标系之间进行转换，就要遵循这个协议
...
// MARK: - 第 2 个讲解 tag
/// 可以通过 tag 来设置和取用 UIView，参考 https://www.jianshu.com/p/7c5b23f76c08
...
// MARK: - 第 4 个讲解 UIViewAutoresizing
// 决定当前视图是否处理触摸事件的唯一对象
// 当设置了 exclusiveTouch 的 UIView 是事件的第一响应者，那么到你的所有手指离开前，其他的视图是不会响应任何触摸事件的
// 参考 https://www.jianshu.com/p/24eb12c5ec82
...
// MARK: - 第 5 个讲解 UIViewAutoresizing
/// 参考 https://www.jianshu.com/p/34d95516efa3
...
// MARK: - 第 6 个讲解 sizeThatFits + sizeToFit
...
// MARK: - 第 10 个讲解 restorationIdentifier
// iOS 状态恢复需要用到
// 参考 https://www.jianshu.com/p/73d8c58ab6fa
